...
/// Builder callback used by [DualTransitionBuilder2].
///
...
class DualTransitionBuilder2 extends StatefulWidget {
  /// Creates a [DualTransitionBuilder2].
  const DualTransitionBuilder2({
    super.key,
  ...
  /// The widget below this [DualTransitionBuilder2] in the tree.
  ///
  ...
  @override
  State<DualTransitionBuilder2> createState() => _DualTransitionBuilder2State();
}

class _DualTransitionBuilder2State extends State<DualTransitionBuilder2> {
  ...
  void _animationListener(AnimationStatus animationStatus) {
    ...
    debugPrint("DTB oldAnimationStatus: " + oldEffective.toString());
    debugPrint("DTB _effectiveAnimationStatus: " + _effectiveAnimationStatus.toString());
  ...
  @override
  void didUpdateWidget(DualTransitionBuilder2 oldWidget) {
